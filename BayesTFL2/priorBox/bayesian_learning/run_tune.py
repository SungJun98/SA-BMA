...
def run_ray(args, config, train_loader, test_loader):
    ...
    analysis = tune.run(
        ...
        resources_per_trial={
            "cpu": 1,#config.cpu_per_trail,
            "gpu": 1,#config.gpu_per_trail
        },
        metric="loss",
        mode="min",
