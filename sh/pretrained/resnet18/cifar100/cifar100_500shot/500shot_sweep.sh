# for seed in 0 1 2
# do
# CUDA_VISIBLE_DEVICES=2 python3 run_baseline.py --method=dnn --optim=sgd --dataset=cifar100 --data_path=/data1/lsj9862/data/cifar100 --use_validation \
...
# for seed in 0 1 2
# do
# CUDA_VISIBLE_DEVICES=2 python3 run_baseline.py --method=dnn --optim=sam --rho=0.1 --dataset=cifar100 --data_path=/data1/lsj9862/data/cifar100 --use_validation \
...
# for seed in 0 1 2
# do
# CUDA_VISIBLE_DEVICES=4 python3 run_baseline.py --method=swag --dataset=cifar100 --data_path=/data1/lsj9862/data/cifar100 --use_validation \
