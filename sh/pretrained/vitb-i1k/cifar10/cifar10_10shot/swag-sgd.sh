...
# for seed in 0 1 2
# do
# CUDA_VISIBLE_DEVICES=5 python3 run_baseline.py --dataset=cifar10 --use_validation --dat_per_cls=10 \
# --method=swag --optim=sgd --model=vitb16-i1k --pre_trained  --epochs=150 --lr_init=1e-3 --wd=1e-2 \
