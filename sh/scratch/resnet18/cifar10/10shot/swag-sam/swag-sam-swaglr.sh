...
# do
# CUDA_VISIBLE_DEVICES=0 python3 run_baseline.py --method=swag --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=10 \
...
# for max_num_models in 3
# do
# CUDA_VISIBLE_DEVICES=7 python3 run_baseline.py --method=swag --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=10 \
# --model=resnet18 --optim=sam --rho=${rho} --epochs=${epochs} --lr_init=${lr_init} --wd=${wd} \
# --scheduler="swag_lr" --swa_lr=${swa_lr} --swa_start=${swa_start} --swa_c_epochs=${swa_c_epochs} --max_num_models=${max_num_models}
# done
# done
...
# --scheduler=swag_lr --swa_lr=1e-3 --swa_start=101 --swa_c_epochs=2 --max_num_models=3 --seed=${seed}
# done
##------------------------------------------------------------------
##------------------------------------------------------------------