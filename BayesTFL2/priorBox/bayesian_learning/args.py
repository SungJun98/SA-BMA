...
def parse_args_SBL(parser):
    ...
    parser.add_argument('--dataset', type=str, required=True, default = "dtd", help='Name of the dataset')
    parser.add_argument('--data_path', type=str, required=True, default = "/home/emforce77/BayesTFL/data" ,help='Path to the dataset')
    parser.add_argument('--dat_per_cls', type=int, required=True, default = 16, help='Number of data points per class')
