...
# do
# CUDA_VISIBLE_DEVICES=${DEVICE} python3 run_baseline.py --dataset=fgvc_aircraft --data_path=/data1/lsj9862/data --use_validation --dat_per_cls=16 \
...
--scheduler=cos_decay --vi_moped_delta=0.2 --kl_beta=1e-1 --seed=${seed}
done