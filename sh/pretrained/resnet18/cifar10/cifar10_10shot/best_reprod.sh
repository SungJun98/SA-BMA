...
# for seed in 0 1 2
# do
# CUDA_VISIBLE_DEVICES=2 python3 run_baseline.py --method=swag --dataset=cifar10 --data_path=/data1/lsj9862/data/ --use_validation --dat_per_cls=10 \
...
for seed in 0 1 2
do
CUDA_VISIBLE_DEVICES=6 python3 run_baseline.py --method=swag --dataset=cifar10 --data_path=/data1/lsj9862/data --use_validation --dat_per_cls=10 \
