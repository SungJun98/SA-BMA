...
for seed in 0 1 2
do
CUDA_VISIBLE_DEVICES=3 python3 run_baseline.py --dataset=cifar100 --data_path=/data1/lsj9862/data --use_validation \
--method=ll_vi --model=resnet18-noBN --optim=sgd --lr_init=1e-2 --wd=1e-3 --epoch=300 \
--scheduler=constant --vi_prior_mu=0.0 --vi_prior_sigma=1.0 --vi_posterior_mu_init=0.0 --vi_posterior_rho_init=-5.0 --vi_moped_delta=0.2 --kl_beta=1e-2 \
