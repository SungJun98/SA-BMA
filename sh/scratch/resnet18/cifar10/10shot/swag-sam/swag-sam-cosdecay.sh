...
# for max_num_models in 3
# do
# CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --method=swag --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=10 \
# --model=resnet18 --optim=sam --rho=${rho} --epochs=${epochs} --lr_init=${lr_init} --wd=${wd} \
# --scheduler="cos_decay" --swa_start=${swa_start} --swa_c_epochs=${swa_c_epochs} --max_num_models=${max_num_models}
# done
# done
...
# do
# CUDA_VISIBLE_DEVICES=3 python3 run_baseline.py --method=swag --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=10 \
# --model=resnet18 --optim=sam --rho=0.1 --epochs=150 --lr_init=1e-2 --wd=1e-3 \
# --scheduler=cos_decay --swa_start=76 --swa_c_epochs=3 --max_num_models=3 --seed=${seed}
# done
##------------------------------------------------------------------
##------------------------------------------------------------------