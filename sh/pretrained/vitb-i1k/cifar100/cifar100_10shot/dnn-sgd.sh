...
# do
# CUDA_VISIBLE_DEVICES=3 python3 run_baseline.py --method=dnn --optim=sgd --dataset=cifar100 --use_validation --dat_per_cls=10 \
...
--method=dnn --optim=sgd --model=vitb16-i1k --pre_trained --lr_init=5e-3 --epochs=100 --wd=1e-2 \
--scheduler=cos_decay --warmup_t=10 \
