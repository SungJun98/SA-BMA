...
do
CUDA_VISIBLE_DEVICES=${DEVICE} python3 run_baseline.py --method=dnn --optim=sam --rho=0.1 --dataset=oxford_pets --data_path=/data1/lsj9862/data/ --use_validation --dat_per_cls=16 \
