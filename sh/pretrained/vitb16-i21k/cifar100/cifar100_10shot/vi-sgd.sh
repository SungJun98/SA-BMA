...
# do
# CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --method=vi --dataset=cifar100 --data_path=/data1/lsj9862/data --use_validation --dat_per_cls=10 \
...
CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --method=vi --dataset=cifar100 --data_path=/data1/lsj9862/data --use_validation --dat_per_cls=10 \
--model=vitb16-i21k --pre_trained \
--optim=sgd --epoch=150 --lr_init=1e-3 --wd=1e-3 \
--scheduler='cos_decay' \
