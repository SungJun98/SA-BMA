...
for seed in 0 1 2
do
CUDA_VISIBLE_DEVICES=7 python3 run_baseline.py --method=ll_swag --dataset=cifar100 --data_path=/data1/lsj9862/data --use_validation \
--model=resnet18-noBN --optim=sgd --epochs=150 --lr_init=5e-3 --wd=1e-4 \
