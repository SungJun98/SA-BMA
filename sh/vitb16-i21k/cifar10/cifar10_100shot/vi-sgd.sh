...
# do
# CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --method=last_vi --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=100 \
...
# for seed in 0 1 2
# do
# CUDA_VISIBLE_DEVICES=5 python3 run_baseline.py --method=last_vi --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=100 \
# --model=vitb16-i21k --pre_trained --linear_probe --optim=sgd --epochs=100 --lr_init=5e-3 --wd=5e-3 \
