...
# do
# CUDA_VISIBLE_DEVICES=0 python3 run_baseline.py --dataset=cifar10 --data_path=/data1/lsj9862/data --use_validation \
...
--scheduler=cos_decay --vi_prior_mu=0.0 --vi_prior_sigma=1.0 --vi_posterior_mu_init=0.0 --vi_posterior_rho_init=-5.0 --vi_moped_delta=0.2 --kl_beta=1e-1 \
