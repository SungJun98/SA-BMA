...
# do
# CUDA_VISIBLE_DEVICES=3 python3 run_baseline.py --dataset=cifar10 --use_validation --dat_per_cls=10 \
...
do
CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --dataset=cifar10 --use_validation --dat_per_cls=10 \
--method=vi --model=resnet18 --pre_trained \
