...
for seed in 0 1 2
do
CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --method=dnn --optim=sgd --dataset=cifar100 --data_path=/data1/lsj9862/data --dat_per_cls=10 --use_validation \
...
for seed in 0 1 2
do
CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --method=dnn --optim=sam --rho=0.05 --dataset=cifar100 --data_path=/data1/lsj9862/data --dat_per_cls=10 --use_validation \
