...
# --load_path="/data2/lsj9862/best_result/seed_${seed}/cifar100/10shot/pretrained_vitb16-i21k/vi-sgd/cos_decay_1e-08/10_1e-07/0.01_0.001_1.0_-3.0_0.1_1.0/" \
# --save_path="/home/lsj9862/SA-BTL/evaluate_vit.csv" --no_save_bma \
...
# do
# CUDA_VISIBLE_DEVICES=4 python3 evaluation.py \
# --load_path="/data2/lsj9862/best_result/seed_${seed}/cifar10/10shot/pretrained_vitb16-i21k/sabma-sabma/cos_decay_1e-08/10_1e-07/0.05_0.0005_0.9_0.1_0.0_1e-05/" \
# --save_path="/home/lsj9862/SA-BTL/evaluate_vit.csv" --no_save_bma \
# --method=sabma --optim=sabma --dataset=cifar10 --dat_per_cls=10 \
# --model=vitb16-i21k --seed=${seed} --severity=${severity}
# done
