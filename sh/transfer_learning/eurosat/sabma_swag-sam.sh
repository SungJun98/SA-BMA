...
# --prior_path="/data2/lsj9862/exp_result/seed_0/eurosat/16shot/pretrained_resnet50/swag-sam/cos_decay_1e-08/10_1e-07/0.005_0.0005_2_51_1_0.1"
# done
# done
# done
...
do
CUDA_VISIBLE_DEVICES=${DEVICE} python3 run_sabma.py --dataset=eurosat --data_path=/data1/lsj9862/data --use_validation --dat_per_cls=16 \
--model=resnet50 --pre_trained --optim=sabma --rho=0.01 --low_rank=-1 --epoch=150 --lr_init=1e-3 \
--scheduler=cos_decay --no_save_bma --kl_eta=0.0 --no_save_bma \
--pretrained_set=downstream \
--prior_path=/data2/lsj9862/exp_result/seed_${seed}/eurosat/16shot/pretrained_resnet50/swag-sam/cos_decay_1e-08/10_1e-07/0.005_0.0005_2_51_1_0.1 \
--seed=${seed}
done