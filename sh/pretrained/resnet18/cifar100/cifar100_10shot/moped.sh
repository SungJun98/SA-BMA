...
# do
# CUDA_VISIBLE_DEVICES=6 python3 run_baseline.py --dataset=cifar100 --data_path=/data1/lsj9862/data/cifar100 --use_validation --dat_per_cls=10 \
...
do
CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --dataset=cifar100 --data_path=/data1/lsj9862/data/cifar100 --use_validation --dat_per_cls=10 \
--method=vi --model=resnet18 --pre_trained \
--optim=sgd --lr_init=1e-2 --wd=1e-3 --epoch=100 --scheduler="cos_decay" \
--vi_prior_mu=0.0 --vi_prior_sigma=1.0 \
