...
# do
# CUDA_VISIBLE_DEVICES=3 python3 run_baseline.py --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=10 \
...
do
CUDA_VISIBLE_DEVICES=1 python3 run_baseline.py --dataset=cifar10 --data_path=/data1/lsj9862/data/cifar10 --use_validation --dat_per_cls=10 \
--method=vi --model=resnet18 --pre_trained \
--optim=sgd --lr_init=1e-2 --wd=1e-4 --epoch=100 --scheduler="cos_decay" \
--vi_prior_mu=0.0 --vi_prior_sigma=1.0 \
--vi_posterior_mu_init=0.0 --vi_posterior_rho_init=-5.0 \
--vi_moped_delta=0.1 \
--kl_beta=0.1 \
--seed=${seed}
done
